...
/**
 * @brief BQ25798 D+ ADC Result Register (REG43h, address 0x43)
 *
 ...
 * LSB: 1 mV
 */
class DplusAdc : public TPS25751Register
{
public:
    // -----------------------------------------------------------------------
    // Constructors
...
private:
    static constexpr uint8_t kExpectedSize = Registers::DPLUS_ADC.size;
};
