...
/**
 * @brief BQ25798 VAC2 ADC Result Register (REG39h, address 0x39)
 *
 * Two-byte read-only register containing the ADC result for VAC2 voltage.
 ...
 * LSB: 1 mV
 */
class Vac2Adc : public TPS25751Register
{
public:
    // -----------------------------------------------------------------------
    // Constructors
    ...
    /**
     * @brief VAC2 voltage in millivolts (unsigned)
...
private:
    static constexpr uint8_t kExpectedSize = Registers::VAC2_ADC.size;
};
