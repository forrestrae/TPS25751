...
/**
 * @brief BQ25798 VBUS ADC Result Register (REG35h, address 0x35)
 *
 * Two-byte read-only register containing the ADC result for VBUS voltage.
 ...
 * LSB: 1 mV
 */
class VbusAdc : public TPS25751Register
{
public:
    // -----------------------------------------------------------------------
    // Constructors
    ...
    /**
     * @brief VBUS voltage in millivolts (unsigned)
...
private:
    static constexpr uint8_t kExpectedSize = Registers::VBUS_ADC.size;
};
