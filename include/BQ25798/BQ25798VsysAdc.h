...
/**
 * @brief BQ25798 VSYS ADC Result Register (REG3Dh, address 0x3D)
 *
 * Two-byte read-only register containing the ADC result for system voltage.
 ...
 * LSB: 1 mV
 */
class VsysAdc : public TPS25751Register
{
public:
    // -----------------------------------------------------------------------
    // Constructors
    ...
    /**
     * @brief System voltage in millivolts (unsigned)
...
private:
    static constexpr uint8_t kExpectedSize = Registers::VSYS_ADC.size;
};
