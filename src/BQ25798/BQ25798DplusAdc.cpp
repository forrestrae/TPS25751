...
uint16_t DplusAdc::millivolts() const
{
...
void DplusAdc::debugPrint(Stream& s) const
{
    s.println(F("=== BQ25798 D+ ADC Register (REG43h) ==="));
...
bool DplusAdc::isSemanticallyValid() const
{
