...
uint16_t Vac1Adc::millivolts() const
{
...
void Vac1Adc::debugPrint(Stream& s) const
{
    s.println(F("=== BQ25798 VAC1 ADC Register (REG37h) ==="));
...
bool Vac1Adc::isSemanticallyValid() const
{
