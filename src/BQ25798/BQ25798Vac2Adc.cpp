...
uint16_t Vac2Adc::millivolts() const
{
...
void Vac2Adc::debugPrint(Stream& s) const
{
    s.println(F("=== BQ25798 VAC2 ADC Register (REG39h) ==="));
...
bool Vac2Adc::isSemanticallyValid() const
{
