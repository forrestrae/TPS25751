...
uint16_t VbusAdc::millivolts() const
{
...
void VbusAdc::debugPrint(Stream& s) const
{
    s.println(F("=== BQ25798 VBUS ADC Register (REG35h) ==="));
...
bool VbusAdc::isSemanticallyValid() const
{
